...
public class TienlenView : GameView
{
    ...
    public void startGame(JObject data) 
    {
        ...
        dealSequence.AppendCallback(() => 
        {
            ...
            SetTurn(turnNameCurrent, timeTurn); // Set lượt đầu tiên
    ...
    {
        // TODO: Implement animation chia bài
        // Có thể dùng DOTween để tạo animation chia bài từ giữa bàn ra các vị trí
    }
