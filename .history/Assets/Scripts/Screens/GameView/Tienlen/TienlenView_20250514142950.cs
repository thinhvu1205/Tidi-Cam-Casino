...
public class TienlenView : GameView
{
    ...
    public void startGame(JObject data)
    {
        ...
        {
            Vector3 deckPosition = new Vector3(0f, 150f, 0f); // Vị trí bộ bài giữa bàn
                ...
                if (cardIndex < playerCards.Count)
                {
                    ...
                    dealSequence.InsertCallback(delay, () =>
                    {
                        ...
                        else
                        {
                            ...
                            {
                                case 1: // Phải
                                    finalPos = new Vector3(498f, 50f + (capturedCardIndex * 3f), 0f);
                                    break;
                                case 2: // Trên
                                    finalPos = new Vector3(40f + (capturedCardIndex * 3f), 250f, 0f);
                                    break;
                                case 3: // Trái
                                    finalPos = new Vector3(-498f, 50f + (capturedCardIndex * 3f), 0f);
                                    break;
