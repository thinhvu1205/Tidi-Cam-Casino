...
public class TienlenView : GameView
{
    ...
    public void onClickDanhBai()
    {
        ...
        Analytics.LogEvent("ClickDanhBai_TienLen");
        
        // 3. Collect selected cards
    ...
    public void onClickBoLuot()
    {
        ...
        // 2. Track event analytics
        Analytics.LogEvent("ClickBoLuot_TienLen");
        ...
        // 5. Optional: Show "Bỏ lượt" indicator for this player
        // TODO: Add UI element for "Bỏ lượt" text/sprite
        // ShowBoLuotIndicator(thisPlayer);
    }
