        ...
        foreach (JObject playerData in data)
        {
            ...
            if (player != null)
            {
                ...
                if (typeWin > 0)
                {
                    ...
                    m_AvatarSpecial.sprite = player.playerView.avatar.sprite;
                    m_NameWin.text = player.displayName;

                    // Set animation type win
                    string animName = "";
                    switch (typeWin)
                    {
                        case 1: animName = "3doithong"; break;
                        case 2: animName = "4doithong"; break;
                        case 3: animName = "tuquy"; break;
                        case 4: animName = "sanh"; break;
                        case 5: animName = "6doi"; break;
                        case 6: animName = "4sam"; break;
                    }
                    if (!string.IsNullOrEmpty(animName))
                    {
                        m_AniCardSpecial.gameObject.SetActive(true);
                        m_AniCardSpecial.AnimationState.SetAnimation(0, animName, false);
                    }
                }
            }
        }
