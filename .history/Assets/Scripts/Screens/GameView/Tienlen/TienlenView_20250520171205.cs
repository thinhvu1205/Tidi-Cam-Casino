...
public class TienlenView : GameView
{
    ...
    private Vector3 m_ButtonDiscardDefaultPosition;
    ...
    public void boLuot(string turnName, string nextTurn, bool newTurn)
    {
        ...
        if (newTurn)
        {
            ...
            if (turnNameCurrent == thisPlayer.namePl)
            {
                ...
                m_ButtonDiscard.transform.localPosition = m_ButtonDiscardDefaultPosition;
                m_ButtonCancel.SetActive(false);
            }
    ...
    protected override void Awake()
    {
        base.Awake();
        instance = this;
        m_ButtonDiscardDefaultPosition = m_ButtonDiscard.transform.localPosition;
        for (int i = 0; i < 4; i++)
        {
