...
public class TienlenView : GameView
{
    ...
    private int typeSort = 0; // Thêm biến để track kiểu sắp xếp    protected override void updatePositionPlayerView()
    {
        ...
        // Khởi tạo vị trí cho animations cháy bài
        InitBurnCardAnimations();
    }
    ...
    }    public void danhBaiError(string error)
    {
        ...
        // Show animation cháy bài cho người chơi chính
        ShowBurnCardAnimation(players.IndexOf(thisPlayer));
    }
    ...
    public void boLuot(string turnName, string nextTurn, bool newTurn)
    {
        ...
        if (newTurn)
        {
            ...
            foreach (var passText in m_TxtPass)
            {
                if (passText != null)
                {
    ...
    private void ShowBurnCardAnimation(int playerIndex) 
    {
    ...
    private void InitBurnCardAnimations()
    {
