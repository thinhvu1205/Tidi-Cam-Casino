...
public class TienlenView : GameView
{
    ...
    }    public void danhBaiError(string error)
    {
        ...
        List<Card> remainingCards = ListCardPlayer[playerIndex];
        
        // Show animation cháy bài nếu vẫn còn bài nhưng không đánh được
        if (remainingCards.Count > 0 && playerIndex >= 0 && playerIndex < m_ListAniChay.Count)
        {
            ...
            if (anim != null)
            {
                ...
                // Tự động ẩn animation sau khi chạy xong
        ...
        // Re-enable các nút nếu vẫn là lượt của người chơi
