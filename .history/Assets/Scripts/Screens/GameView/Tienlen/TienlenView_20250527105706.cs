        ...
        finishSequence.AppendCallback(() => {
            foreach (JObject playerData in data) {
                ...
                if (money < 0) {
                  ...
                  //  player.playerView.showEffectWinLose(-1);
                    player.playerView.effectFlyMoney(money);
                    
                    // Tạo 10 chip bay ra từ người thua
                    for (int i = 0; i < 10; i++) {
                        ...
                        // Animation bay ra
                        chip.transform.DOMove(randomPos, 0.25f).SetEase(Ease.OutQuint);
                    }
                }
                // Người thắng sẽ có M > 0  
                    ...
                    DOVirtual.DelayedCall(2f, () => {
                       // player.playerView.showEffectWinLose(1);
                        ...
                        // Animation các chip bay về người thắng
                        foreach (var chip in vtChipFinish) {
                            Sequence chipSequence = DOTween.Sequence();
                            chipSequence.Append(
                                chip.transform.DOMove(player.playerView.transform.position, 0.25f)
                                .SetEase(Ease.OutQuint)
                            );
                            chipSequence.AppendCallback(() => {
