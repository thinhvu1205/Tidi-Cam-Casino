        ...
        finishSequence.AppendCallback(() => {
                ...
                if (money < 0) {
                    ...
                    for (int i = 0; i < 10; i++) {
                        ...
                        DOTween.Sequence()
                            ...
                            .Append(chip.transform.DOMove(centerPos, 0.5f).SetEase(Ease.OutQuint));
                    }
                }
                else if (money > 0) {
                    winPlayer = player;
            ...
            if (winPlayer != null) {
                DOVirtual.DelayedCall(3f, () => {
                    winPlayer.playerView.effectFlyMoney(getLong(data.First(x => getString(x, "N") == winPlayer.namePl), "M"));
