    ...
    private void SetDiscardCardPosition(List<Card> cards, int playerIndex)
    {
        ...
        for (int i = 0; i < cards.Count; i++)
        {
            ...
            if (isSpecialHand)
            {
                ...
                seq.Append(card.transform.DOScale(new Vector3(0.6f, 0.6f, 1f), 0.15f));
                seq.Join(card.transform.DOLocalRotate(new Vector3(0f, 180f, 0f), 0.15f, RotateMode.LocalAxisAdd));
