    ...
    private void SetDiscardCardPosition(List<Card> cards, int playerIndex)
    {
        ...
        for (int i = 0; i < cards.Count; i++)
        {
            ...
            if (isSpecialHand)
            {
                ...
                // Giai đoạn 1: Di chuyển ra giữa bàn + xoay + scale to
                seq.Append(
                    DOTween.Sequence()
                ...
                // Giai đoạn 2: Di chuyển về vị trí đích + scale nhỏ lại (không xoay)
                seq.Append(
                    DOTween.Sequence()
