              ...
              DOVirtual.DelayedCall(delay, () =>
{
    ...
    float totalRotateTime = 1.0f;
    float moveToFinalTime = 0.4f;

    Sequence seq = DOTween.Sequence();

    // 👉 Bước 1: Move ra giữa bàn + scale to 1
    ...
    // 👉 Bước 2: Hiệu ứng lấp lánh & xoay 360° (mượt)
    seq.AppendCallback(() =>
    {
    ...
    // 👉 Bước 3: Đợi chút rồi move về vị trí đích + scale nhỏ lại
