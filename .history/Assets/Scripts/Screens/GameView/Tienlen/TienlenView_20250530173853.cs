...
public class TienlenView : GameView
{
    ...
    private void SetDiscardCardPosition(List<Card> cards, int playerIndex)
    {
        ...
        for (int i = 0; i < cards.Count; i++)
        {
            ...
            if (isSpecialHand)
            {
                ...
                {
                    float moveToCenterTime = 0.4f;   // thời gian move + scale to lớn
                    float totalRotateTime = 0.6f;    // thời gian xoay 360°
                    ...
                    seq.Insert(0, DOVirtual.DelayedCall(0f, () => card.setEffect_Twinkle(true, 1.6f)));
    ...
    {
        HandleData.DelayHandleLeave = 11f;
        // 1. Initial setup
        int type = -1;
        long moneyWin = 0;
