        ...
        for (int i = 0; i < cards.Count; i++)
        {
            ...
            if (isSpecialHand)
            {
                DOVirtual.DelayedCall(delay, () =>
                {
                    ...
                    // 📌 Bắt đầu hiệu ứng twinkle ngay khi anim bắt đầu
                    seq.Insert(0f, DOVirtual.DelayedCall(0f, () => card.setEffect_Twinkle(true, 1.6f)));

                    // 📈 Scale to + 🧲 Move to center + 🔁 Rotate 180° cùng lúc
                    ...
                    seq.Join(card.transform.DOLocalRotate(new Vector3(0f, 180f, 0f), animTime, RotateMode.LocalAxisAdd)
                        ...
                        .OnUpdate(() =>
                        {
                            ...
                            {
                                card.setTextureWithCode(code); // lật sang mặt thật
                                flippedToFront = true;
                            }
                        }));

                    // ⏳ Đợi chút rồi move về finalPos + scale nhỏ lại
