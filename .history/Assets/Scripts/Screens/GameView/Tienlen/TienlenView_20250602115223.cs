        ...
        for (int i = 0; i < cards.Count; i++)
        {
            ...
            if (isSpecialHand)
            {
                ...
                DOVirtual.DelayedCall(delay, () =>
                {
                    ...
                    // 📈 Move to center + scale to full size
                    ...
                    // 🔁 Flip 2 bước: 90° -> đổi mặt -> 90°
                    seq.Append(card.transform.DOLocalRotate(new Vector3(0f, 90f, 0f), animTime / 2f, RotateMode.LocalAxisAdd)
                        .SetEase(Ease.InOutSine));
                    seq.AppendCallback(() =>
                    {
                        card.setTextureWithCode(code); // Đổi mặt bài tại góc 90°
                    });
                    seq.Append(card.transform.DOLocalRotate(new Vector3(0f, 90f, 0f), animTime / 2f, RotateMode.LocalAxisAdd)
                        .SetEase(Ease.InOutSine));

                    // 🏁 Move về vị trí cuối cùng + scale lại nhỏ
