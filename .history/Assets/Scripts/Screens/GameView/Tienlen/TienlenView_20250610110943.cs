...
public class TienlenView : GameView
{
                ...
                DOVirtual.DelayedCall(delay, () =>
 {
    ...
    public static bool checkXamTL(List<Card> listIn)
    {
        ...
        // Sắp xếp bài theo số
        var sortedCards = new List<Card>(listIn);
        sortedCards.Sort((a, b) => a.N.CompareTo(b.N));
        
        // Check 3 lá cùng số
        bool sameNumber = sortedCards[0].N == sortedCards[1].N && 
                         sortedCards[1].N == sortedCards[2].N;
                         
        // Check 3 lá khác chất
        bool differentSuits = sortedCards[0].S != sortedCards[1].S && 
                             sortedCards[1].S != sortedCards[2].S &&
                             sortedCards[0].S != sortedCards[2].S;
                             
        return sameNumber && differentSuits;
    }
